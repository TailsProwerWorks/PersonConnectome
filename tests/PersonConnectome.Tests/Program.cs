...
internal static class TestData
{
    ...
    public static readonly string[] BridgeMembers = ["DesiredWalkingDirection", "InfluenceMotorSpeed", "GripBehaviour", "PersonConnectomeLimbController", "limb.name", "LeftArm", "RightArm", "LeftLeg", "RightLeg", "Core", "Head", "LeftGrip", "RightGrip", "LiveBodySummary", "LiveEnvironmentSummary", "LiveLimbSummary", "DisplayMotorSummary", "PositionLabel", "BloodRegenerationPerSecond", "BurnIntensity", "ContextMenuOptionComponent", "ContextMenuButton", "startWalking", "startProtect", "startSit", "startPetrified", "startStumbling", "SortingLayer.layers", "sortingLayerID", "sortingOrder", "_ZTest", "CompareFunction.Always", "LiquidDistribution", "entry.Value.Raw", "Liquid.GetIdentity", "GetHeartRate", "Physics2D.OverlapCircleNonAlloc", "Physics2D.Linecast", "ClosestPoint", "GetComponentInParent", "audio.volume", "OwnerRoot", "GunshotWoundCount", "beingHeldByGripper", "ProjectileBehaviour", "GorseProjectileBehaviour", "GenericScifiProjectileBehaviour", "MachineGunProjectileBehaviour", "LaunchedRocketBehaviour", "PhysicalBehaviour.rigidbody", "body.velocity", "TextMeshPro", "Camera.main", "malecns-v1.0.png", "ModAPI.LoadTexture", "texture.height - 1 - sourceRow", "no fallback graph", "adapter.Apply(brain.Step(sensory), true)", "AverageHealth", "BrainDamaged", "Braindead", "Alive", "BrainDead", "IsTerminal", "BRAIN DEAD", "BRAIN INJURED", "BRAIN DEATH", "Stop()", "REQUEST: STOPPED", "NEURAL: STOPPED"];
    public static readonly string[] WiredGameSensors = ["Pain", "Damage", "Bleeding", "Health", "Fire", "Heat", "Cold", "AmbientHeat", "AmbientCold", "Shock", "Oxygen", "SubmergedHypoxia", "Wetness", "Blood", "Infection", "Charge", "AcidExposure", "LiquidExposure", "LiquidHazard", "LiquidSedation", "LiquidStimulation", "LiquidHealing", "LiquidWater", "Nearby", "NearbyDirection", "Vision", "Light", "Touch", "Impact", "Vibration", "Sound", "LimbLoss", "Breakage", "JointStress", "Consciousness", "Adrenaline", "Velocity", "Rotation", "Proprioception", "Fall", "Projectile", "Unconscious", "Balance", "Heartbeat", "BrainDamage", "Seizure", "Frozen", "Paralysis", "Numbness", "Vitality", "LungDamage", "InternalBleeding", "Circulation", "Disconnected", "Wounds", "Lava", "BurnProgress", "Stabbed", "PhysicalContact", "Weightless", "Sliding"];
}
