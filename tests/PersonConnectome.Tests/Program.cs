...
internal static class TestData
{
    ...
    public static readonly string[] WiredGameSensors = ["Pain", "Damage", "Bleeding", "Health", "Fire", "Heat", "Cold", "Shock", "Oxygen", "SubmergedHypoxia", "Wetness", "Blood", "Infection", "Charge", "LiquidExposure", "LiquidHazard", "LiquidSedation", "LiquidStimulation", "LiquidHealing", "LiquidWater", "Nearby", "NearbyDirection", "Light", "Touch", "Impact", "Sound", "LimbLoss", "JointStress", "Consciousness", "Adrenaline", "Velocity", "Rotation", "Unconscious", "Balance", "Heartbeat", "BrainDamage", "Seizure", "Frozen", "Paralysis", "Numbness", "Vitality", "LungDamage", "InternalBleeding", "Circulation", "Disconnected", "Wounds", "Lava", "BurnProgress", "Stabbed", "PhysicalContact", "Weightless", "Sliding"];
}
