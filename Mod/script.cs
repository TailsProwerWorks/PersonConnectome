...
namespace Mod
{
    public static class Mod
    {
        public static void Main()
        {
            ...
            ModAPI.Register(new Modification
            {
                ...
                DescriptionOverride = "Active bounded connectome control. F7 shows diagnostics.",
    ...
    internal sealed partial class ConnectomeBrain
    {
        ...
        public string DisplaySummary { get { return stopped ? "NEURAL: STOPPED queued=0 processed=0 deferred=0 fired=0" : "NEURAL: in=" + LastSensoryDrive.ToString("0.00") + " queued=" + pending.Count + " processed=" + processedThisStep + " deferred=" + deferredThisStep + " fired=" + fired.Count; } }
        public string DisplayInputSummary { get { return stopped ? "INPUT: STOPPED" : "INPUT: injury=" + injuryDrive.ToString("0.00") + " hazard=" + hazardDrive.ToString("0.00") + " motion=" + motionDrive.ToString("0.00") + " arousal=" + arousalDrive.ToString("0.00") + " total=" + LastSensoryDrive.ToString("0.00"); } }
        public string DisplayMotorSummary { get { return stopped ? "REQUEST: STOPPED arm=0.00/0.00 leg=0.00/0.00 head=0.00 core=0.00 grip=0.00/0.00" : "REQUEST: arm=" + lastCommand.LeftArm.ToString("0.00") + "/" + lastCommand.RightArm.ToString("0.00") + " leg=" + lastCommand.LeftLeg.ToString("0.00") + "/" + lastCommand.RightLeg.ToString("0.00") + " head=" + lastCommand.Head.ToString("0.00") + " core=" + lastCommand.Core.ToString("0.00") + " grip=" + lastCommand.LeftGrip.ToString("0.00") + "/" + lastCommand.RightGrip.ToString("0.00"); } }
